#ifndef __cnx_X86_H__
#define __cnx_X86_H__
...
inline void cnx_hash(const void *__restrict__ input, size_t size, void *__restrict__ output, cnx_ctx *__restrict__ ctx)
{
...
template<size_t ITERATIONS, size_t MEM, size_t MASK, bool SOFT_AES>
inline void cnx_double_hash(const void *__restrict__ input, size_t size, void *__restrict__ output, struct cnx_ctx *__restrict__ ctx)
{

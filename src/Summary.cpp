...
#   endif
    ...
    Log::i()->text(Options::i()->colors() ? "\x1B[01;32m * \x1B[01;37mVERSIONS:     \x1B[01;36mgchgrp/%s\x1B[01;37m libuv/%s%s" : " * VERSIONS:     gchgrp/%s libuv/%s%s",
